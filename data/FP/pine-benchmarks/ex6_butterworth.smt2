; ex6_butterworth.txt converted to CHC format
; Original: Butterworth low-pass filter
; State: x0, x1, x2, x3, x4
; Input: in0 ∈ [-1.0, 1.0]
; Initial: x0 = 0, x1 = 0, x2 = 0, x3 = 0, x4 = 0
; Transition: x0' = 0.4250*x0 + 0.8131*in0
;            x1' = 0.3167*x0 + 0.1016*x1 - 0.4444*x2 + 0.1807*in0
;            x2' = 0.1278*x0 + 0.4444*x1 + 0.8207*x2 + 0.0729*in0
;            x3' = 0.0365*x0 + 0.1270*x1 + 0.5202*x2 + 0.4163*x3 - 0.5714*x4 + 0.0208*in0
;            x4' = 0.0147*x0 + 0.0512*x1 + 0.2099*x2 + 0.57104*x3 + 0.7694*x4 + 0.0084*in0
...
; Initial state: x0 = 0, x1 = 0, x2 = 0, x3 = 0, x4 = 0, in0 ∈ [-1.0, 1.0]
(assert (forall ((x0 (_ FloatingPoint 8 24)) (x1 (_ FloatingPoint 8 24)) (x2 (_ FloatingPoint 8 24)) (x3 (_ FloatingPoint 8 24)) (x4 (_ FloatingPoint 8 24)) (in0 (_ FloatingPoint 8 24)))
         (=> (and (fp.eq x0 ((_ to_fp 8 24) RNE 0.0))
             ...
             (inv x0 x1 x2 x3 x4 in0))))

; Transition relation
(assert (forall ((x0 (_ FloatingPoint 8 24)) (x1 (_ FloatingPoint 8 24)) (x2 (_ FloatingPoint 8 24)) (x3 (_ FloatingPoint 8 24)) (x4 (_ FloatingPoint 8 24)) (in0 (_ FloatingPoint 8 24))
                 (x0! (_ FloatingPoint 8 24)) (x1! (_ FloatingPoint 8 24)) (x2! (_ FloatingPoint 8 24)) (x3! (_ FloatingPoint 8 24)) (x4! (_ FloatingPoint 8 24)) (in0! (_ FloatingPoint 8 24)))
         (=> (and (inv x0 x1 x2 x3 x4 in0)
                  (fp.eq x0! (fp.add RNE (fp.mul RNE ((_ to_fp 8 24) RNE 0.4250) x0)
