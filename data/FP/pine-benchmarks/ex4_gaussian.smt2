; ex4_gaussian.txt converted to CHC format
; Original: Linear quadratic gaussian regulator
; State: x0, x1, x2
; Input: in0 ∈ [-1.0, 1.0]
; Initial: x0 = 0, x1 = 0, x2 = 0
; Transition: x0' = 0.9379*x0 - 0.0381*x1 - 0.0414*x2 + 0.0237*in0
...
; Initial state: x0 = 0, x1 = 0, x2 = 0, in0 ∈ [-1.0, 1.0]
(assert (forall ((x0 (_ FloatingPoint 8 24)) (x1 (_ FloatingPoint 8 24)) (x2 (_ FloatingPoint 8 24)) (in0 (_ FloatingPoint 8 24)))
...
; Transition relation
(assert (forall ((x0 (_ FloatingPoint 8 24)) (x1 (_ FloatingPoint 8 24)) (x2 (_ FloatingPoint 8 24)) (in0 (_ FloatingPoint 8 24))
                 (x0! (_ FloatingPoint 8 24)) (x1! (_ FloatingPoint 8 24)) (x2! (_ FloatingPoint 8 24)) (in0! (_ FloatingPoint 8 24)))
         (=> (and (inv x0 x1 x2 in0)
                  (fp.eq x0! (fp.add RNE (fp.add RNE (fp.add RNE (fp.mul RNE ((_ to_fp 8 24) RNE 0.9379) x0)
