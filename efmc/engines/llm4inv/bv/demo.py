...
def run_demo_with_prover(
    ...
    if result.is_safe:
        ...
        logger.warning("✗ %s: No invariant found", example_name)
...
if __name__ == "__main__":
    # NOTE: this demo uses local llm be default, you can change it to
    # remote llm by setting the llm_provider to 'remote'
    main()
