...
from pyparsing import (Keyword as K, Literal as L, OneOrMore, ParserElement,
                       Regex as R, StringEnd, Suppress as S, Word as W,
                       delimitedList, infixNotation, nums, opAssoc)
...
class DaikonInvParser(InfixExprParser):
    ...
    def __init__(s):
        ...
        s.BoolExpr = infixNotation(s.RelExpr, [
        ...
        s.WarnInv = (S(R(r"warning: too few samples for [a-zA-Z\._]* invariant:")) +
                     s.JustInv | s.JustInv)
